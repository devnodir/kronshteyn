...
import { NEWS_DELETE, NEWS_GET_ALL } from '@/utils/variables'
...
const News: React.FC = () => {
	...
	const { data, isLoading, refetch } = useApi(NEWS_GET_ALL)
	const { mutate, isLoading: deleteLoad } = useApiMutationID("delete", NEWS_DELETE)

	const redirect = (id?: any) => {
		if (id) navigate(`/news/update/${id}`)
		else navigate("/news/create")
	}
