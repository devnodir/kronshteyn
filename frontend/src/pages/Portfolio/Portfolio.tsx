...
import { PORTFOLIO_DELETE, PORTFOLIO_GET_ALL } from '@/utils/variables'
...
const Portfolio: React.FC = () => {
	...
	const { mutate, isLoading: deleteLoad } = useApiMutationID("delete", PORTFOLIO_DELETE)

	const redirect = (id?: any) => {
		if (id) navigate(`/portfolio/update/${id}`)
		else navigate("/portfolio/create")
	}
